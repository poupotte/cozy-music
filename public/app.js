...
(function() {
  ...
  require.register('backbone.marionette', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'backbone.marionette//lib/core/')); }), {});
...
require.register('backbone.babysitter', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'backbone.babysitter//lib/')); }), {});
    (function(exports,require,module) {
      // Backbone.BabySitter
// -------------------
// v0.1.10
...
require.register('backbone.wreqr', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'backbone.wreqr//lib/')); }), {});
    (function(exports,require,module) {
...
require.register('backbone', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'backbone//')); }), {});
    (function(exports,require,module) {
      //     Backbone.js 1.2.3
...
require.register('underscore', function(exports,req,module){
    var require = __makeRequire((function(n) { return req(n.replace('./', 'underscore//')); }), {});
    (function(exports,require,module) {
      //     Underscore.js 1.8.3
...
var _tracks = require('views/tracks');
...
var Application = function (_Mn$Application) {
    _inherits(Application, _Mn$Application);
    ...
    return Application;
}(_backbone2.default.Application);
...
require.register("collections/playlists", function(exports, require, module) {
'use strict';
...
require.register("collections/tracks", function(exports, require, module) {
'use strict';
...
// TEST MUSIC FILE
cozysdk.run('Files', 'getMusicFiles', {}, function (error, response) {
...
var Tracks = _backbone2.default.Collection.extend({
    ...
    sync: function sync(method, model, options) {
        if (method == 'read') {
            console.log('fetch');
            cozysdk.run('Track', 'getAllTrack', {}, function (error, response) {
...
;require.register("views/templates/track", function(exports, require, module) {
...
require.register("views/tracks", function(exports, require, module) {
'use strict';
